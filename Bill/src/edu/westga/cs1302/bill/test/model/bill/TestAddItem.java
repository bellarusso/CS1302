...
class TestAddItem {
  ...
  void testAddToEmptyBill() {
    ...
    assertEquals("orange", bill.getItems().get(0).getName(),
        "checking name of the first bill item");
  ...
  @Test
    ...
    assertEquals("orange", bill.getItems().get(0).getName(),
        "checking name of the first bill item");
    assertEquals(1, bill.getItems().get(0).getAmount(), "checking amount of the first bill item");
    assertEquals("banana", bill.getItems().get(1).getName(),
        "checking name of the second bill item");
